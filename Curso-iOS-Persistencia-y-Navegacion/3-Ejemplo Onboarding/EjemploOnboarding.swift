    ...
    var body: some View {
        NavigationStack {
            List {
                Section("Añadir") {
                    HStack {
                        TextField("Nuevo artículo...", text: $nuevoItemText)
...
struct VistaOnboarding: View {
    ...
    var body: some View {
        TabView {
            ...
            crearPagina(color: .green, titulo: "Sin trampa ni cartón", desc: "Aplicación 100% gratuita")
